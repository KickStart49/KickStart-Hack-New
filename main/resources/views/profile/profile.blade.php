                  ...
                  <form class="form" action="##" method="post" id="registrationForm">
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <label for="last_name"><h4>Last name</h4></label>{{ $user->name }}<br>
                              <label for="phone"><h4>Phone</h4></label><br>
                              <label for="mobile"><h4>Mobile</h4></label><br>
                              <label for="email"><h4>Email</h4></label>{{ $user->email }}<br>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(".file-upload").on('change', function(){
        ...
        <div class="container bootstrap snippet">
    <div class="row">
      <div class="col-sm-10"><h1>User name</h1></div><br>
